            ...
            <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
                    <div className="sub-items">
                        ...
                        <div className="sub-titles">
                            <div className="title">Univers imaginaire —,</div>
                            <div className="author">par <p className="colors-others">Louisa</p>.</div>
                        </div>
                        ...
                        <div className="links">
                            ...
                            <NavLink to="/coming-soon" className="active title-link">
                                <FontAwesomeIcon icon={faBook} className="icon" /> Mon prochain livre
                            </NavLink>
                        </div>
                    </div>
            </nav>
